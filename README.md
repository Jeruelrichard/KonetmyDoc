Project overview: Basic HTML/CSS/JS site with 19 pages.

Naming: HTML files as page-name.html (e.g., about.html), CSS as page-name.css (e.g., about.css).

Structure per HTML: Every page must include <!DOCTYPE html>, <html lang="en">, <head> with <link rel="stylesheet" href="../CSS/variables.css">, <link rel="stylesheet" href="../CSS/base.css"> and <link rel="stylesheet" href="../CSS/page-name.css"> (if specific styles needed), and <script src="js/script.js"></script> if JS is used.
